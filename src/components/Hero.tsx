      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        <div id="hero-text-content" className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          >
            ...
            <span>{hero?.badge || 'Pasti Bersih, Pasti Enak!'}</span>
          </motion.div>
          ...
          >
            {hero?.headline || 'Frozen Food Ikan Marinasi Siap Goreng, Siap Santap!'}
          </motion.h1>
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <span className="text-[11px] uppercase tracking-wider text-brand-dark/50 font-semibold">Ikan Probiotik</span>
            </div>
            <div className="flex flex-col gap-1 border-x border-brand-soft/60 px-4">
              ...
              <span className="text-[11px] uppercase tracking-wider text-brand-dark/50 font-semibold">Protein Alami</span>
            </div>
            <div className="flex flex-col gap-1 pl-2">
              <span className="font-display font-bold text-xl text-brand-primary">LOKAL</span>
              <span className="text-[11px] uppercase tracking-wider text-brand-dark/50 font-semibold">UMKM Banyumas</span>
            </div>
          </motion.div>
        </div>
        ...
        <div id="hero-graphic" className="lg:col-span-5 flex items-center justify-center relative">
          ...
          >
            ...
            <div className="w-[88%] h-[88%] rounded-3xl overflow-hidden shadow-2xl border-4 border-brand-light relative group bg-brand-light">
              <img src={produklosgo} alt="Produk LOSGo" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
