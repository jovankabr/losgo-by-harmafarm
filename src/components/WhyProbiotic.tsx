      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div id="keunggulan-header" className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-base text-brand-dark/70">
            Produk HarmaFarm diolah dari ikan pilihan kualitas premium yang dipastikan <strong>TANPA BAU TANAH</strong>, dimarinasi dengan bumbu berkualitas, dan diproses secara higienis untuk menghadirkan cita rasa terbaik bagi Orang Indonesia.
          </p>
        </div>
            ...
            >
              <div>
                <div className="flex justify-between items-center border-b border-brand-soft/60 pb-4 mb-6">
                  ...
                  <div className="bg-brand-primary text-brand-light font-black text-xs uppercase py-3 px-5 rounded-xl text-center leading-tight whitespace-nowrap">
                    <div>PASTI BERSIH,</div>
                    <div>PASTI ENAK!</div>
                  </div>
                </div>
